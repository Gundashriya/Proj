...
resource "azurerm_app_service" "as" {
  ...
  connection_string {
    name  = "Database"
    type  = "SQLServer"
    value = "Server=tcp:shriya-sql.database.windows.net,1433;Initial Catalog=shriya-db;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;Authentication='Active Directory Default';"
  }
}
...
resource "azurerm_mssql_server" "server" {
    ...
    location = azurerm_resource_group.rg.location
    version = "12.0"
    administrator_login = "shriyagunda"
    administrator_login_password = "Shriy@gund@$12345$"
}
